  ...
  <div className="systems reveal" style={{marginTop: '48px'}}>
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/kalki.jpg" alt="Kalki UCAV" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/garuda.jpg" alt="Garuda Swarm" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/dhruv.jpg" alt="Dhruv C-UAS" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/drishti.jpg" alt="Drishti ISR Pod" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
          <g transform="translate(200 100)">
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/trishuleye-panel.jpg" alt="Trishuleye Panel" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
      ...
      <Link className="system__link" href="/trishuleye">Experience the Panel →</Link>
    </article>
  </div>
</section>
  ...
  <div className="systems reveal" style={{marginTop: '48px'}}>
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/krishi.jpg" alt="Krishi Drone" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/bhumi.jpg" alt="Bhumi Mapper" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
          {/* survey grid */}
    ...
    <article className="system">
      <div className="system__visual">
        ...
        <img className="cover" src="/img/systems/vahak.jpg" alt="Vahak Cargo" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          <svg viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
          <rect width="400" height="200" fill="#0a0c0f"/>
          <g transform="translate(200 100)">
            {/* fuselage with wings */}
